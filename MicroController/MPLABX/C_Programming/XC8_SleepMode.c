...
// CONFIG2H
#pragma config BORV = VBOR_2P85 // Brown-out Reset Voltage Selection bits (Brown-out Reset Voltage (VBOR) set to 2.45V)
...
#define ON 1 
#define OFF 0
#define LED_D0  PORTDbits.RD0
#define LED_D1  PORTDbits.RD1    
...
void main(void) {
    ...
    WDTCON0 = 0b00011001;  // This changes the watchdog timer value - refer to data sheet      
    ...
    while(1)
    {
        ...
        //asm("sleep");
        SLEEP();
        LED_D1=0;  // Good morning
        for (int i=0; i<10; i++){ // 10 blinks
            LED_D0 = !LED_D0;
            __delay_ms(100);
        }
    }
